      ...
      <SafeAreaView style={styles.flex} edges={['top', 'bottom']}>
        ...
        <View style={styles.column}>
          ...
          <Animated.View entering={FadeInDown.duration(500).delay(200)} style={styles.heading}>
            <Text style={[styles.title, { color: colors.navy }]}>{STRINGS.chooseRoleTitle}</Text>
            <Text style={[styles.brand, { color: colors.primary }]}>{STRINGS.chooseRoleBrand}</Text>
          </Animated.View>

          <View style={styles.cards}>
            <FeatureCard
              icon="people-outline"
              title={STRINGS.staffRoleTitle}
              description={STRINGS.staffRoleSubtitle}
              color="#06B6D4"
              width={cardWidth}
            ...
            <FeatureCard
              ...
              description={STRINGS.adminRoleSubtitle}
              color="#635BFF"
              width={cardWidth}
